...
DROP TABLE IF EXISTS attendance_IT_6;
DROP TABLE IF EXISTS attendance_CSE_6;
DROP TABLE IF EXISTS attendance_AI_DS_6;
DROP TABLE IF EXISTS attendance_CME_6;
DROP TABLE IF EXISTS attendance_ECE_6;
DROP TABLE IF EXISTS attendance_EEE_6;
...
CREATE TABLE IF NOT EXISTS attendance_IT_1 (
    ...
    Time_slot VARCHAR(20) NOT NULL DEFAULT (get_time_slot()),
    Day VARCHAR(10) NOT NULL DEFAULT (DAYNAME(CURRENT_DATE)),
